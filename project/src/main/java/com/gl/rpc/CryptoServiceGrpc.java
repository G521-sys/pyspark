...
public final class CryptoServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.gl.rpc.CryptoProto.EncryptRequest,
      com.gl.rpc.CryptoProto.EncryptResponse> getEncryptMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Encrypt",
      requestType = com.gl.rpc.CryptoProto.EncryptRequest.class,
      responseType = com.gl.rpc.CryptoProto.EncryptResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.gl.rpc.CryptoProto.EncryptRequest,
      com.gl.rpc.CryptoProto.EncryptResponse> getEncryptMethod() {
    io.grpc.MethodDescriptor<com.gl.rpc.CryptoProto.EncryptRequest, com.gl.rpc.CryptoProto.EncryptResponse> getEncryptMethod;
      ...
      synchronized (CryptoServiceGrpc.class) {
        if ((getEncryptMethod = CryptoServiceGrpc.getEncryptMethod) == null) {
          CryptoServiceGrpc.getEncryptMethod = getEncryptMethod =
              io.grpc.MethodDescriptor.<com.gl.rpc.CryptoProto.EncryptRequest, com.gl.rpc.CryptoProto.EncryptResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Encrypt"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gl.rpc.CryptoProto.EncryptRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gl.rpc.CryptoProto.EncryptResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.gl.rpc.CryptoProto.DecryptRequest,
      com.gl.rpc.CryptoProto.DecryptResponse> getDecryptMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Decrypt",
      requestType = com.gl.rpc.CryptoProto.DecryptRequest.class,
      responseType = com.gl.rpc.CryptoProto.DecryptResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.gl.rpc.CryptoProto.DecryptRequest,
      com.gl.rpc.CryptoProto.DecryptResponse> getDecryptMethod() {
    io.grpc.MethodDescriptor<com.gl.rpc.CryptoProto.DecryptRequest, com.gl.rpc.CryptoProto.DecryptResponse> getDecryptMethod;
    if ((getDecryptMethod = CryptoServiceGrpc.getDecryptMethod) == null) {
      synchronized (CryptoServiceGrpc.class) {
        if ((getDecryptMethod = CryptoServiceGrpc.getDecryptMethod) == null) {
          CryptoServiceGrpc.getDecryptMethod = getDecryptMethod =
              io.grpc.MethodDescriptor.<com.gl.rpc.CryptoProto.DecryptRequest, com.gl.rpc.CryptoProto.DecryptResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Decrypt"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gl.rpc.CryptoProto.DecryptRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.gl.rpc.CryptoProto.DecryptResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void encrypt(com.gl.rpc.CryptoProto.EncryptRequest request,
        io.grpc.stub.StreamObserver<com.gl.rpc.CryptoProto.EncryptResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getEncryptMethod(), responseObserver);
    }

    /**
     */
    default void decrypt(com.gl.rpc.CryptoProto.DecryptRequest request,
        io.grpc.stub.StreamObserver<com.gl.rpc.CryptoProto.DecryptResponse> responseObserver) {
  ...
  public static final class CryptoServiceStub
    ...
    /**
     */
    public void encrypt(com.gl.rpc.CryptoProto.EncryptRequest request,
        io.grpc.stub.StreamObserver<com.gl.rpc.CryptoProto.EncryptResponse> responseObserver) {
    ...
    /**
     */
    public void decrypt(com.gl.rpc.CryptoProto.DecryptRequest request,
        io.grpc.stub.StreamObserver<com.gl.rpc.CryptoProto.DecryptResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class CryptoServiceBlockingStub
    ...
    /**
     */
    public com.gl.rpc.CryptoProto.EncryptResponse encrypt(com.gl.rpc.CryptoProto.EncryptRequest request) {
    ...
    /**
     */
    public com.gl.rpc.CryptoProto.DecryptResponse decrypt(com.gl.rpc.CryptoProto.DecryptRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CryptoServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.gl.rpc.CryptoProto.EncryptResponse> encrypt(
        com.gl.rpc.CryptoProto.EncryptRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.gl.rpc.CryptoProto.DecryptResponse> decrypt(
        com.gl.rpc.CryptoProto.DecryptRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ENCRYPT:
          serviceImpl.encrypt((com.gl.rpc.CryptoProto.EncryptRequest) request,
              (io.grpc.stub.StreamObserver<com.gl.rpc.CryptoProto.EncryptResponse>) responseObserver);
          break;
        case METHODID_DECRYPT:
          serviceImpl.decrypt((com.gl.rpc.CryptoProto.DecryptRequest) request,
              (io.grpc.stub.StreamObserver<com.gl.rpc.CryptoProto.DecryptResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.gl.rpc.CryptoProto.EncryptRequest,
              com.gl.rpc.CryptoProto.EncryptResponse>(
                service, METHODID_ENCRYPT)))
        .addMethod(
          getDecryptMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.gl.rpc.CryptoProto.DecryptRequest,
              com.gl.rpc.CryptoProto.DecryptResponse>(
  ...
  private static abstract class CryptoServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.gl.rpc.CryptoProto.getDescriptor();
    }
